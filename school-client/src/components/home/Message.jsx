...
const Message = () => {
  ...
  return (
    <section className="max-w-11/12 w-full mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10">
      {/* Chairman Message */}
      <div className="self-start">
        <div className="border border-[#013223] rounded-xl bg-white shadow-lg hover:shadow-xl transition-all duration-300">
          ...
          <div className="bg-white m-3 p-3 shadow-inner rounded-lg flex flex-col items-center text-center">
            ...
            <div className="w-full">
              ...
              <div className={`text-base leading-relaxed text-justify overflow-hidden transition-all duration-500 ease-in-out ${isChairmanExpanded ? 'max-h-[1000px] opacity-100' : 'max-h-48 opacity-100'}`}
              >
                <p>
                ...
                <div className={`transition-all duration-500 ease-in-out ${isChairmanExpanded
                  ? '' : 'h-0 overflow-hidden'}`}
                >
                  <div className={`${isChairmanExpanded ? 'mt-4' : ''}`}>
                    <p>
            ...
            <button
              ...
              className="mt-4 px-6 py-2 bg-[#013223] text-white rounded-lg hover:bg-[#006747] transition-all duration-300 font-semibold transform hover:scale-105 active:scale-95"
            >
      ...
      <div className="self-start">
        <div className="border border-[#013223] rounded-xl bg-white shadow-lg hover:shadow-xl transition-all duration-300">
          ...
          <div className="bg-white m-3 p-3 shadow-inner rounded-lg flex flex-col items-center text-center">
            ...
            <div className="w-full">
              {/* Smooth expandable content container */}
              <div className={`text-base leading-relaxed text-justify overflow-hidden transition-all duration-500 ease-in-out ${isPrincipalExpanded ? 'max-h-[1000px] opacity-100' : 'max-h-48 opacity-100'}`}
              >
                <p>
                ...
                <div className={`transition-all duration-500 ease-in-out ${isPrincipalExpanded
                  ? '' : 'h-0 overflow-hidden'}`}
                >
                  <div className={`${isPrincipalExpanded ? 'mt-4' : ''}`}>
                    <p>
