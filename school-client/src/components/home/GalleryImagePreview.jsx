        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
          {images.slice(0, 6).map((img, index) => (
            ...
            >
              ...
              <div className="absolute inset-0 bg-[#00000070] bg-opacity-40 opacity-0 group-hover:opacity-100 transition-all duration-300 flex justify-center items-center text-white font-medium">
                View Image
              </div>
            </div>
          ))}
