  ...
  return (
    <div className="w-full lg:max-w-7xl mx-auto">
      ...
      <div className="">
        ...
        {/* <p className="mt-2 text-xl te sm:text-lg li-font">
      ...
      <div className="mt-4 text-justify text-gray-800 leading-relaxed">
        <p>
          ...
          <br />
          <br />
          বর্তমানে এ প্রতিষ্ঠানে ১ জন প্রধান শিক্ষক, ১ জন সহকারী প্রধান শিক্ষক
          এবং ১৩ জন সহকারী শিক্ষক দক্ষতা ও নিষ্ঠার সঙ্গে পাঠদান কার্যক্রম
          পরিচালনা করছেন। পাশাপাশি প্রশাসনিক ও দাপ্তরিক কার্যক্রম সুষ্ঠুভাবে
          পরিচালনার জন্য ৬ জন কর্মকর্তা-কর্মচারী নিয়োজিত রয়েছেন। বিদ্যালয়টিতে
          বর্তমানে ৩৫০ জনেরও বেশি শিক্ষার্থী অধ্যয়নরত রয়েছে।
        </p>
      </div>
    </div>
  );
