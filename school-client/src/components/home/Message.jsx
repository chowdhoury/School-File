      ...
      <section className="max-w-11/12 w-full mx-auto flex flex-col lg:flex-row gap-10">
        ...
        <div className="flex-1 border border-[#013223] rounded-xl bg-white shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
          ...
          <div className="bg-white m-3 p-3 shadow-inner rounded-lg flex flex-col items-center text-center">
            ...
            <p className="text-base leading-relaxed text-justify">
              ...
              সুনাম ও সফলতার সঙ্গে এগিয়ে চলেছে। শান্ত ও শিক্ষাবান্ধব পরিবেশে
              মানসম্মত শিক্ষা প্রদানের যে স্বপ্ন নিয়ে এই প্রতিষ্ঠান যাত্রা শুরু
              করেছিল, আজ শিক্ষক ও শিক্ষার্থীদের নিষ্ঠা ও পরিশ্রমের মাধ্যমে সেই
              স্বপ্ন বাস্তব রূপ পেয়েছে।
              <br />
              <br />
              বর্তমান যুগে শিক্ষা কেবল পাঠ্যবইয়ের মধ্যে সীমাবদ্ধ নয়; বরং
              ...
              শিক্ষার্থী, অভিভাবক ও স্থানীয় জনগণের সম্মিলিত প্রচেষ্টা সবচেয়ে বড়
              শক্তি। এই ঐক্য ও সহযোগিতার মাধ্যমেই আমাদের বিদ্যালয় একসময় খোকসা
              উপজেলায় শিক্ষার ক্ষেত্রে একটি অনুসরণযোগ্য প্রতিষ্ঠানে পরিণত হয়েছে
              এবং ভবিষ্যতেও আরও এগিয়ে যাবে।
              <br />
              <br />
              বিদ্যালয়ের উন্নয়ন ও সাফল্যের এই যাত্রায় যাঁরা বিভিন্নভাবে সহযোগিতা
              ও সমর্থন দিয়ে পাশে থেকেছেন, তাঁদের প্রতি আমি আন্তরিক কৃতজ্ঞতা
              প্রকাশ করছি। আমি বিশ্বাস করি, সবার সম্মিলিত প্রচেষ্টা, নতুন ভাবনা
              ও আধুনিক দৃষ্টিভঙ্গির মাধ্যমে মোড়াগাছা মাধ্যমিক বিদ্যালয় ভবিষ্যতে
        ...
        <div className="flex-1 border border-[#013223] rounded-xl bg-white shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
          ...
          <div className="bg-white m-3 p-3 shadow-inner rounded-lg flex flex-col items-center text-center">
            ...
            <p className="text-base leading-relaxed text-justify">
              মোড়াগাছা মাধ্যমিক বিদ্যালয়ের প্রধান শিক্ষক হিসেবে দায়িত্ব পালন
              করতে পারা আমার জন্য অত্যন্ত গৌরব ও সম্মানের বিষয়। প্রতিষ্ঠালগ্ন
              থেকেই এই বিদ্যালয়টি অত্র অঞ্চলে শিক্ষার আলো ছড়িয়ে দিতে নিরলসভাবে
              কাজ করে যাচ্ছে। আমরা বিশ্বাস করি, প্রকৃত শিক্ষা কেবল পাঠ্যবই ও
              শ্রেণিকক্ষের মধ্যেই সীমাবদ্ধ নয়; বরং এটি জ্ঞান, শৃঙ্খলা, সৃজনশীলতা
              ও নৈতিক মূল্যবোধের সমন্বয়ে একজন মানুষকে পরিপূর্ণ করে গড়ে তোলার
              একটি ধারাবাহিক প্রক্রিয়া।
              <br />
              <br />
              আমাদের নিবেদিতপ্রাণ শিক্ষকবৃন্দ, সহযোগিতাপরায়ণ অভিভাবক এবং উদ্যমী
              শিক্ষার্থীরাই বিদ্যালয়ের সাফল্যের মূল ভিত্তি। সম্মিলিত প্রচেষ্টার
              মাধ্যমে আমরা এমন একটি শিক্ষাবান্ধব পরিবেশ গড়ে তুলতে
              ...
              গুরুত্ব দিচ্ছি, যাতে আমাদের শিক্ষার্থীরা কেবল পরীক্ষায় সফলই না হয়,
              বরং বাস্তব জীবনের চ্যালেঞ্জ মোকাবিলায় আত্মবিশ্বাসী ও দায়িত্বশীল
              নাগরিক হিসেবে গড়ে ওঠে।
              <br />
              <br />
              ...
              সবাই একসঙ্গে কাজ করে মোড়াগাছা মাধ্যমিক বিদ্যালয়ের ঐতিহ্য ও সুনামকে
              আরও উচ্চতর পর্যায়ে নিয়ে যাই।
            </p>
